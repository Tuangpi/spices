...
const Content = () => {
  ...
  return (
    <section className="w-[90%] m-auto sm:w-[85%] mt-8">
      {contents &&
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-x-8 lg:gap-x-9">
              ...
              <div className="self-start sm:col-span-8 md:col-span-9">
                ...
                <Link
                  to="/content/detail"
                  state={content}
                  className="px-3 mt-4 cursor-pointer inline-block py-1.5 bg-blue-300 rounded-md outline-none shadow-sm text-sm text-white"
                >
                  Read More
                </Link>
              </div>
