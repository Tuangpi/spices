...
const FrontLayout = () => {
  ...
  return (
    <>
      <nav className="w-full sm:relative py-5 font-Montserrat bg-slate-100 sm:bg-transparent">
        ...
        <div className="py-2 lg:py-1.5 bg-slate-100 hidden sm:block my-4 mt-8">
          <div className="flex justify-center items-center gap-x-0 md:gap-x-3 w-full m-auto uppercase text-[13px] md:text-sm font-medium">
        ...
        {humburgerMenu && (
          <div className="absolute w-full h-full bg-slate-100 opacity-95 flex flex-col items-start pr-10 pt-6 sm:hidden">
      ...
      <Outlet context={humburgerMenu} />
      <footer
        className={`font-Montserrat font-medium ${
          humburgerMenu
            ? "hidden sm:block"
            : "uppercase text-center bg-slate-100 py-2 mt-16 text-xs md:text-sm font-light"
        }`}
      >
